...
//	}
	...
	public void setData(Data data) {
		...
		setT(data.mon0X,data.mon0Y,"Mon0");
		setT(data.mon1X,data.mon1Y,"Mon1");
		setT(data.mon2X,data.mon2Y,"Mon2");
		setT(data.mon3X,data.mon3Y,"Mon3");
		setT(data.mon4X,data.mon4Y,"Mon4");
		setT(data.mon5X,data.mon5Y,"Mon5");
	}
